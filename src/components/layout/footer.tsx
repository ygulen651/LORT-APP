      ...
      <Container>
        <div className="relative py-20">
          <div className="flex flex-col items-center text-center gap-8">
            {/* Brand Section */}
            <div>
              <Link href="/" className="group inline-flex items-center space-x-6 mb-8">
                <div className="relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-orange-500 to-orange-600 rounded-3xl blur-2xl opacity-0 group-hover:opacity-60 transition-all duration-500"></div>
                  <Image 
                    src="/LORT LOGO1.png" 
                    alt="LORT APP Logo" 
                    width={400} 
              ...
              {/* Social Media with Modern Cards */}
              <div className="flex gap-3 justify-center">
                <Link 
                  href="https://www.facebook.com/lortapp" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="group p-3 rounded-2xl glass-dark hover:bg-white/20 transition-all duration-300 hover:scale-110"
                >
                  <Facebook className="h-5 w-5 text-orange-400 group-hover:text-orange-300 transition-colors" />
                </Link>
                <Link 
                  ...
                  className="group p-3 rounded-2xl glass-dark hover:bg-white/20 transition-all duration-300 hover:scale-110"
                >
                  <Instagram className="h-5 w-5 text-orange-400 group-hover:text-orange-300 transition-colors" />
                </Link>
              </div>
            </div>
          </div>
